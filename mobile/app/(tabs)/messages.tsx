...
import { View, Text, Alert, TouchableOpacity, TextInput, ScrollView, Image, Modal, KeyboardAvoidingView, Platform } from 'react-native'
  ...
  const deleteConversation = (conversationId : number) => {
    Alert.alert("Delete Conversation", "Are you sure you want to delete this conversation?", [
      ...
      },
      {
        ...
        style: "destructive",
        onPress: () => {
          setConversationsList(conversationsList.filter((conversation) => conversation.id !== conversationId));
        }
      }
    ])
  }
          ...
          <SafeAreaView className='flex-1'>
            ...
            >
               <View className='flex-row items-center px-4 py-3 border-t border-gray-100'>
                <View className='flex-1 flex-row rounded-full -center bg-gray-100 px-4 py-3 mr-3'>
                  <TextInput 

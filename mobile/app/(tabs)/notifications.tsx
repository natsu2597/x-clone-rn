...
const NotificationScreen = () => {
  const {notifications, deleteNotification, isDeletingNotification,error, isLoading, isRefetching, refetch} = useNotification();
  ...
  return (
    <SafeAreaView className='flex-1 bg-white' edges={["top"]}>
      ...
      <View className='flex-row items-center justify-between px-4 py-3 border-b border-gray-100'>
        <Text className='text-xl font-bold text-gray text-gray-900'>
          Notifications
        </Text>
        <TouchableOpacity>
